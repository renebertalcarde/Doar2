...
export declare const StyledContainer: import("styled-components").StyledComponent<
    ({ p, pl, pr, pt, pb, m, ml, mr, mt, mb, ...props }: any) => JSX.Element,
    any,
    IProps,
    never
>;
export declare const StyledRow: import("styled-components").StyledComponent<
    ({ p, pl, pr, pt, pb, m, ml, mr, mt, mb, ...props }: any) => JSX.Element,
    any,
    IProps,
    never
...
export declare const StyledCol: import("styled-components").StyledComponent<
    ({
        p,
        pl,
        pr,
