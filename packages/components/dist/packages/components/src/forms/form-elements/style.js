...
var s,
    ...
    S = c(
        ...
        t("colors.gray700"),
        function (n) {
            return l(n.theme.colors.primary).lighten(25).toString();
        },
        t("shadows.input"),
        function (o) {
            return (
                "noborder" === o.$customStyle &&
                c(
                    p ||
                        (p = n(
                            [
    ...
    C = e("div").withConfig({
        shouldForwardProp: function (n, e) {
            return !o([], r(j), !1).includes(n) && e(n);
        },
    })(
        A ||
            (A = n(
...
export {
    W as ErrorInputStyles,
    S as InputStyles,
    C as StyledBoxWrap,
    v as SuccessInputStyles,
    $ as WarningInputStyles,
    j as allowedProps,
};
